...
@IBDesignable @objc class ADVSegmentedControl: UIControl {
    ...
    func setupLabels(){
        ...
        for index in 1...items.count {
            ...
            let attributedString = NSMutableAttributedString(string: items[index - 1], attributes:
                [
                    NSFontAttributeName: UIFont(name: "Avenir-Black", size: 15)!,
                    NSForegroundColorAttributeName: index == 1 ? selectedLabelColor : unselectedLabelColor,
