...
- (void)commonInit {
    ...
    _backgroundColor = [UIColor colorWithRed:49.0f/255.0f green:49.0f/255.0f blue:61.0f/255.0f alpha:1.0f];
    self.opaque = NO;
    _selectionIndicatorColor = [UIColor colorWithRed:226.0f/255.0f green:56.0f/255.0f blue:83.0f/255.0f alpha:1.0f];
    
    self.selectedSegmentIndex = 0;
    self.segmentEdgeInset = UIEdgeInsetsMake(0, -100, 0, -100);
...
- (NSDictionary *)resultingTitleTextAttributes {
    NSDictionary *defaults = @{
        NSFontAttributeName : [UIFont systemFontOfSize:12.0f weight:0.3f],
