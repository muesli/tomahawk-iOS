...
- (void)viewDidLoad {
    ...
    self.segmentedControl.items = @[@"FEED", @"COLLECTION"];
...
//    NSLog(@"Object is %d", [object toInt32]);
    ...
    songsController1.title = @"FOR YOU";
    ...
    NSArray *controllerArray = @[songsController, songsController1, chartsController];
    NSDictionary *parameters = @{
                                 ...
                                 CAPSPageMenuOptionBottomMenuHairlineColor : [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.1]
                                 };
