...
-(IBAction)moreButtonTouched:(UIButton *)button forEvent:(UIEvent *)event{
    ...
    NSString *song = selectedCell.textLabel.text;
    NSString *artist = selectedCell.detailTextLabel.text;
    UIAlertController *more = [UIAlertController alertControllerWithTitle:song message:artist preferredStyle:UIAlertControllerStyleActionSheet];
    ...
    [more addAction:[UIAlertAction actionWithTitle:@"Go to Album" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        //Goto Artist
    }]];
